    ...
    beforeWrite: (files) => {
      for (const file of files) {
        ...
        if (file.path.endsWith('.mdx')) {
          ...
          file.content = file.content.replace(/{\/\* This file was generated by Fumadocs\. Do not edit this file directly\. Any changes should be made by running the generation command again\. \*\/}/g, '');
