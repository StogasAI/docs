...
The verifier always fails closed after signed expiry. High availability therefore requires multiple healthy gateways and reliable bundle distribution; attestation cannot prevent denial of service.
